...
\begin{enumerate}[label=\alph*), leftmargin=2em, itemsep=0.3em]
    \item Each year, the Club shall undertake at least one project that:
    \begin{itemize}[leftmargin=1.5em, itemsep=0.2em]
...
\begin{enumerate}[label=\alph*), leftmargin=2em, itemsep=0.3em]
    ...
    \item The Project Lead has the authority to select team members based on skills, interest, and availability.
    \item A minimum of 3 members (including the Project Lead) is required for a project team to be formally recognized.
\end{enumerate}
\\
\textbf{Project Management:}
\begin{enumerate}[label=\alph*), leftmargin=2em, itemsep=0.3em]
    \item The Project Lead shall establish milestones, assign tasks, and monitor progress.
